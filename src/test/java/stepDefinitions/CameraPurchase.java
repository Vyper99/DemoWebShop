...
public class CameraPurchase {
    ...
    //  wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a[href=\"/camera-photo\"]"))).click();
    //  wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a[href=\"/digital-slr-camera\"]"))).click();
